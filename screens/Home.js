...
const Home = () => {
  const [background, setBackground] = useState({
    uri:
      "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcRwQZ2s5TKxJm8pAGaRDt0VehyvikwU3zgd1I1iR-KD7QsNHmcN",
    name: "Tenet",
  ...
  const [gallery, setGallery] = useState([
    ...
    },
    {
      ...
      key: "2",
      desc:
        "A new letter for help from the girl Feng Jihua arrived in the monster mailbox. Recently, strange incidents have occurred in her surroundings. Before Kitaro and his party arrived, Hua was dragged into the mirror by the monster Mirror. Then Lord Kagami scattered Onitaros companions to various parts of the country, and shut Onitaro into the mirror world. Kitaro went through hardships before he escaped from the world in the mirror. In ancient times, the wild fighting god sealed by King Yan Mo was awakened, and he possessed a powerful force above all monsters. Feng Jihua is holding the key to the recovery of the Wild Fight God. Knowing the truth, Kitaro is determined to protect the girl Hua and save Japan. Forty-seven monsters came together to start an unprecedented monster war...",
    },
    {
      image:
        "https://images-na.ssl-images-amazon.com/images/I/71rgiqKm5ZL._AC_SY741_.jpg",
    ...
    },
    {
      ...
      key: "4",
      desc:
        "Detective Conan: The Fist of Blue Sapphire is a 2019 Japanese animated film. It is the twenty-third installment of the Case Closed film series based on the manga series of the same name by Gosho Aoyama, following the 2018 film Detective Conan: Zero the Enforcer. The film was released on 12 April 2019. ",
    },
    {
      image:
        "https://images-na.ssl-images-amazon.com/images/I/71d-53%2BeM0L._AC_SL1093_.jpg",
      title: "About Time",
    ...
    <ScrollView style={{ backgroundColor: "#000" }}>
      ...
      <View style={{ marginHorizontal: 14 }}>
        ...
        <ImageBackground
          source={{
            uri:
              "https://storage.googleapis.com/www-cw-com-tw/article/202002/article-5e5737dd478ab.jpg",
          }}
